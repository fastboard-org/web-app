  ...
  (
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "grid min-w-[8rem] items-start gap-1.5 rounded-lg border border-slate-200 border-slate-200/50 bg-foreground-100 px-2.5 py-1.5 text-xs shadow-xl dark:border-slate-800 dark:border-slate-800/50 ",
          className,
        )}
      >
